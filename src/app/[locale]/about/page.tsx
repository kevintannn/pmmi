      ...
      <section className="section pt-0">
        <div className="container grid gap-8 lg:grid-cols-2">
          <Reveal direction="right">
            <Card className="h-full">
              <CardContent className="p-8">
                <Placeholder src='/images/mission-title.webp' label={ph('office')} ratio="video" className="mb-6" />
          ...
          <Reveal direction="left">
            <Card className="h-full">
              <CardContent className="p-8">
                <Placeholder src='/images/vision-title.webp' label={ph('droneView')} ratio="video" className="mb-6" />
